...
# functions---------------------------------------------------------------------------------
async def mini_game_cmd(interaction: discord.Interaction) -> None:
...
async def mini_game_prehistory(interaction: discord.Interaction) -> None:
    message =  ('давным-давно люди жили в мире с природой и животными...\n'
                ...
                'Ваш питомец - возможно единственный в своём роде, может останлвить Карков! тренируёте его и спасите землю от Карков!\n')
    await interaction.response.send_message(message)
